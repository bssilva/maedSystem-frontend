...
function newCPS(){
    return(
        window.location.href = '/admin/CPS/cadastrar'
    );
}

export default function CPSListagem() {
    ...
    useEffect(() => {
        ...
        async function loadCps() {
            const response = await api.get("/cadastroCPS");
                            ...
                            <Paper className={classes.paper}>
                                <Grid>
                                    <Fab color="primary" aria-label="add">
                                        <AddIcon onClick={newCPS}/>
                                    </Fab>
                                </Grid>
                                <h2>Listagem de Funcionários CPS</h2>
                                <Grid container spacing={3}>
