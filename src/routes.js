        ...
        <BrowserRouter>
            <StoreProvider>
                <Switch>
                    ...
                    <RoutesPrivate path="/admin/CLT/editar/:idCLT" exact component={EditarFuncionarioCLT} />
                    ...
                    <RoutesPrivate path="/admin/CPS/editar/:idCPS" exact component={EditarFuncionarioCPS} />
                    ...
                    <RoutesPrivate path="/admin/MEI/editar/:idMEI" exact component={EditarFuncionarioMEI} />
                    ...
                    <RoutesPrivate path="/admin/passagem/editar" exact component={EditarPassagens} />
                    ...
                    <RoutesPrivate path="/admin/usuarios/editar/:idusuarios" exact component={EditarUsuario} />
                </Switch>
            </StoreProvider>
        </BrowserRouter>
    )
